...
* In Github, fork `https://github.com/ilius/gowsdl` to your own account
* Get the package using "go get": `go get github.com/ilius/gowsdl`
* Move to where the package was cloned: `cd $GOPATH/src/github.com/ilius/gowsdl/`
